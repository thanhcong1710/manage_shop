...
Route::group(
    ...
    function () {
        ...
        Route::get('/data-agency/export', [DashboardController::class, 'export'])->name('admin.dashboard.export');
        ...
        Route::group(['prefix' => 'orders'], function () {
            ...
            Route::get('/export/order', [OrdersController::class, 'export'])->name('admin.orders.export');
        });
        ...
        Route::group(['prefix' => 'stocks'], function () {
            ...
            Route::get('/invoice-print/{id}', [StocksController::class, 'printInvoice'])->name('admin.stocks.printInvoice');
            # locations
